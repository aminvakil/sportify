...
class CreateUserCommand extends Command
{
    ...
    {
        $this
            ->setName('sportify:user:create')
            ->setDescription('Create a regular user')
            ->addArgument('email', InputArgument::REQUIRED, 'User email address')
            ->addArgument('username', InputArgument::OPTIONAL, 'Username. Defaults to the email address.')
            ->addOption('password', null, InputOption::VALUE_REQUIRED, 'User password. If omitted, the command asks for it interactively.')
            ->addOption('slack-username', null, InputOption::VALUE_REQUIRED, 'User Slack username.', 'slack_username')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln(sprintf('<info>User <comment>%s</comment> was created.</info>', $email));
